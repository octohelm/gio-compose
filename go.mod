module github.com/octohelm/gio-compose

go 1.21.0

replace gioui.org => github.com/morlay/gio v0.0.0-20231010083638-596eb36c24de
...
require (
	...
	goki.dev/enums v0.9.41 // indirect
